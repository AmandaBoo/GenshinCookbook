...
export const PlaceholderPage = ({welcomeText, imgPath, addButtonText, onAddButtonClick, onHelpGuideButtonClick}) => {
    ...
    return (
        <div className={"flex-center help-container"}>
            <div className={"vertical-center"}>
                ...
                <div>
                    {createMessageBody(welcomeText, onAddButtonClick, addButtonText, onHelpGuideButtonClick)}
                </div>
            </div>
        </div>
    );
...
function createMessageBody(welcomeText, onAddButtonClick, addButtonText, onHelpGuideButtonClick) {
    return (
        <div>
